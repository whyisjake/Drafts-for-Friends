...
class JS_Drafts_For_Friends	{
	...
	public function add_admin_pages(){
		add_submenu_page( 'edit.php', __( 'Drafts for Friends', 'drafts-for-friends' ), __( 'Drafts for Friends', 'drafts-for-friends' ), 'edit_posts', $this->slug,  array( $this, 'output_existing_menu_sub_admin_page' ) );
	}
